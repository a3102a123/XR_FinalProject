...
public class HighlightsFX : MonoBehaviour
{
    ...
    {
        var data = new OutlineData() { color = Color, sortingType = sortingType };
    ...
    private void Awake()
    {
        ...
        m_highlightMaterial = new Material(Resources.Load("Highlight") as Shader);
        m_blurMaterial = new Material(Resources.Load("MobileBlur") as Shader);
